...
public static class DataGenerator
{
    public static Database GenerateDatabase(GenerationRequest request)
    {
        ...
        var userFaker = new Faker<User>("en")
            ...
            .RuleFor(u => u.City, f => f.Address.City().ToLimitString(40))
            .RuleFor(u => u.State, f => f.Address.State().ToLimitString(40))
            .RuleFor(u => u.Country, f => f.Address.Country().ToLimitString(40))
        ...
        var invoiceFaker = new Faker<Invoice>("en")
            ...
            .RuleFor(i => i.InvoiceNumber, f => "INV" + f.Random.Guid().ToString().Replace("-", "").Substring(0, 10))
            .RuleFor(i => i.BillingAddress, f => f.Address.StreetAddress().ToLimitString(70))
            .RuleFor(i => i.BillingCity, f => f.Address.City().ToLimitString(40))
            .RuleFor(i => i.BillingState, f => f.Address.State().ToLimitString(40))
            .RuleFor(i => i.BillingCountry, f => f.Address.Country().ToLimitString(40))
